...
1. Clone the repository and package the Spring Boot application:
bash :
...
6. Port Forwarding (Bypass NAT/Localhost Issues)
...
💻 Usage & Demonstration
Access the Portal: Open your web browser and navigate to http://localhost:####.
